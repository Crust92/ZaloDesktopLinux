# Chi tiết kỹ thuật — Zalo Desktop for Linux

> Ghi chép đầy đủ về cách ghép, các bản vá (P1–P13), hai kho media, hiệu năng và đưa lên store.
> README chính chỉ tóm tắt — tài liệu này giữ toàn bộ chi tiết.
